module Scoreable
  ...
  def score_user(user)
    ...
    result = TournamentDayResult.create(tournament_day: self, user: user, primary_scorecard: primary_scorecard, flight: self.flight_for_player(user), gross_score: gross_score, net_score: net_score, front_nine_gross_score: front_nine_gross_score, front_nine_net_score: front_nine_net_score, back_nine_net_score: back_nine_net_score)
