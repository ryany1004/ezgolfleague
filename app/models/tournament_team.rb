class TournamentTeam < ApplicationRecord
  ...
  has_many :tournament_teams, class_name: "TournamentTeam", foreign_key: "parent_team_id"
  belongs_to :parent_team, class_name: "TournamentTeam", touch: true

  validate :players_are_valid, on: :update
  def players_are_valid
    other_teams = self.tournament_day.tournament_teams
