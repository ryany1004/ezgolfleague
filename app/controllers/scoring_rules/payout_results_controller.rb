  ...
  class PayoutResultsController < ::BaseController
    ...
    def create
      ...
      if @payout_result.save
        redirect_to league_tournament_tournament_day_scoring_rule_payout_results_path(@tournament.league, @tournament, @tournament_day, @scoring_rule), flash:
        { success: 'The payout result was successfully added.' }
      else
        render :new
      end
    end
    ...
    def update
      if @payout_result.update(payout_result_params)
        redirect_to league_tournament_tournament_day_scoring_rule_payout_results_path(@tournament.league, @tournament, @tournament_day, @scoring_rule), flash:
        { success: 'The payout result was successfully updated.' }
      else
        render :edit
      end
    end
    ...
    def destroy
      ...
      redirect_to league_tournament_tournament_day_scoring_rule_payout_results_path(@tournament.league, @tournament, @tournament_day, @scoring_rule), flash:
      { success: 'The payout result was successfully deleted.' }
    end
