class Api::V1::RegistrationsController < Api::V1::ApiBaseController
  ...
  def create_league
    ...
    league = League.create(name: name, location: location, show_in_search: appear_in_search, dues_amount: 0.0, contact_name: @current_user.complete_name, contact_email: @current_user.email, contact_phone: @current_user.phone_number, league_description: "")
