...
describe "Testing Best Ball Game Type" do
  let(:user) { FactoryGirl.create(:user, first_name: "Best Ball", last_name: "1") }
  let(:user_2) { FactoryGirl.create(:user, first_name: "Best Ball", last_name: "2", email: "user2@domain.com") }
  ...
  let(:tournament) { FactoryGirl.create(:tournament, league: league, name: "Hunter Best Ball") }
  let(:tournament_day) { FactoryGirl.create(:tournament_day, tournament: tournament, course: course, game_type_id: 10) }
